...
public class CPUPunchCardReaderTileEntity extends TileEntity implements
IInventory {

	private ItemStack[] inv;

	public CPUPunchCardReaderTileEntity() {
		inv = new ItemStack[1];
	}
	...
	public String getInventoryName() {
		return "z80.cpupunchcardreadertileentity";
	}
...
//	
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		...
		if (stack.getItem() == CPUMod.punchCard)
			return true;
	...
	public void readFromNBT(NBTTagCompound tagCompound) {
		...
		NBTTagList tagList = tagCompound.getTagList("Items", 10); // NBTBase.NBTTypes ["COMPOUND"]
